                ...
                <div className="bg-[#181818] h-full flex flex-col lg:flex-row  pt-10 pb-10 pr-4 pl-4">
                  <div className="flex  justify-center items-center text-left   w-full">
                    <div className="pl-10 ">
                      ...
                      <p className="text-white mt-8 ">View Map Locations</p>
                    </div>
                  </div>

                  <div className="flex items-center justify-center text-left w-full mt-10">
                    <div className="pl-10">
                      <p className="text-white">SOCIAL UPDATES</p>
                      <p className="mt-12 text-white">
                        You May Wonder : Why This Event Popular
                      </p>

                      <div className="icons justify-start flex h-40 items-center text-2xl  gap-2">
